...
export default function HomeSec3() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setOffset(window.scrollY * 0.1); // تتحكم في الحركة
    };
        ...
        <div className=" w-max-1 xl:text-left text-center">
          ...
          <div>
            <p className="text-gray-600 dark:text-gray-300 text-[18px] px-5 font-medium">
              What We Do? <h1>- Digital assets audit</h1> <h1>- Research & competitive
              analysis</h1> <h1>- Target audience segmentation</h1> <h1>- Customer persona &
              content personalization strategy</h1> <h1>- Digital communications strategy</h1>
              <h1>- Creative, social media & Digital advertising strategy</h1> <h1>- Business
              intelligence & reporting tools</h1>
            </p>
          </div>
